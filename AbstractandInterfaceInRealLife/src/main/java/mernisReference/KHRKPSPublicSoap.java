...
public class KHRKPSPublicSoap
{
    ...
    public KHRKPSPublicSoap(){}

    public KHRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KHRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KHRExtendedSoapSerializationEnvelope envelope= new KHRExtendedSoapSerializationEnvelope(KHRExtendedSoapSerializationEnvelope.VER11);
