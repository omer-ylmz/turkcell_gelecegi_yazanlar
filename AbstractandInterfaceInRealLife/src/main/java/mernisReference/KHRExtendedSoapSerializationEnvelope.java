...
class KHRSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class KHRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KHRDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new KHRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KHRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KHRDateTimeConverter dateTimeConverter = new KHRStandardDateTimeConverter();

    public KHRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KHRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KHRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KHRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KHRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KHRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
